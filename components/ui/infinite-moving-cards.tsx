  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li key={item.name}
            className="relative shrink-0 rounded-md px-3 py-2 dark:border-zinc-700 bg-[linear-gradient(180deg,#27272a,#18181b)]"
          >
            <blockquote className="flex flex-row items-center">
              ...
              ></div>
              <img src={item.urlIcon} alt="" className="w-5 h-5 mr-2" />
